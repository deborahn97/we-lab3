...
--
-- Host: 127.0.0.1
-- Generation Time: Jun 21, 2022 at 02:52 PM
...
(16, 'tincidunt, nunc ac mattis ornare, lectus', 'molestie orci tincidunt adipiscing. Mauris molestie pharetra nibh. Aliquam', 222, '4', 8, 3),
(17, 'lorem, luctus ut,', 'dictum cursus. Nunc mauris elit, dictum eu, eleifend nec, malesuada ut, sem.', 167, '4', 8, 4),
(18, 'lacus. Etiam bibendum fermentum', 'eu, euismod ac, fermentum vel, mauris. Integer sem elit, pharetra ut, pharetra sed, hendrerit', 286, '6', 10, 5),
(19, 'volutpat. Nulla facilisis. Suspendisse commodo tincidunt', 'neque tellus, imperdiet non, vestibulum nec, euismod in, dolor. Fusce feugiat.', 283, '4', 9, 3),
(20, 'accumsan neque et nunc.', 'nostra, per inceptos hymenaeos. Mauris ut quam vel', 219, '4', 10, 3),
(21, 'pede blandit congue. In', 'ligula. Aliquam erat volutpat. Nulla dignissim. Maecenas ornare egestas ligula.', 166, '6', 10, 5),
(22, 'malesuada ut, sem. Nulla', 'Class aptent taciti sociosqu ad litora torquent', 123, '5', 5, 3),
(23, 'Praesent eu dui. Cum', 'at, velit. Pellentesque ultricies dignissim lacus. Aliquam rutrum', 285, '7', 7, 5),
(24, 'pharetra nibh. Aliquam ornare,', 'nonummy. Fusce fermentum fermentum arcu. Vestibulum ante ipsum primis in faucibus orci luctus', 103, '5', 6, 5),
(25, 'Mauris quis turpis vitae purus gravida', 'malesuada fames ac turpis egestas. Fusce aliquet magna a neque. Nullam ut nisi', 191, '5', 10, 5);
...
CREATE TABLE `tbl_users` (
  ...
  `user_home_address` varchar(250) NOT NULL,
...
INSERT INTO `tbl_users` (`user_id`, `user_email`, `user_name`, `user_phone`, `user_password`, `user_home_address`, `user_status`, `user_reg_date`) VALUES
(1, 'deb.naz97@gmail.com', 'Deborah N', '0116175807', '6367c48dd193d56ea7b0baad25b19455e529f5ee', '5, Solok Mahang 5A, Taman Meru Utama,\r\nBatu 6, Jalan Meru,\r\n41050 Klang, Selangor.', 'Unverified', '2022-06-07 01:34:42.380785');
